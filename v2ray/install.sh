#!/bin/bash
# ./install.sh -p http://127.0.0.1:10808

# GitHub 镜像加速配置（加速下载，可选）
# 可用镜像: https://ghproxy.com/ 或 https://ghgo.xyz/ 或 https://mirror.ghproxy.com/
# 如不需要镜像加速，设置为空: GITHUB_MIRROR=""
GITHUB_MIRROR=""
...
download() {
    ...
    [[ $GITHUB_MIRROR ]] && link="${GITHUB_MIRROR}${link}"
